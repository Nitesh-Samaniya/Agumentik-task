...
const Client = () => {
  return (
    <Box mt={'100px'} pl={['10px','10px','10px','70px']} pr={['10px','10px','10px','70px']} mb={10}>
        <Hide below='500px'>
            <Box 
                position={'relative'}
                w={'100%'}
                ...
                <Box>
                    <Image w={'100%'} h={'100%'} src='https://s3-alpha-sig.figma.com/img/d4f4/9952/37c462a1c541b7a812220d9a0ad0c7ce?Expires=1679875200&Signature=XQgdDg20KSFHjEetzwZYdILmITubkuNf96VTvQZwUonMNcbP6yySLBapZakm70CxJdeO8fpd-WirZwssIKXfiaabAwkZnvYithHyWWXz84~L-fMRo7dcdgSDI8wVVm~O~SWdU3cxqyKCLXK2F~SuyXWQNtz6y2~-j80RPtzY1vNJipGE49mElsgeNKNTnnG4vcrH5YwhdpNc3~~mJC-KSAIM0dmGUWnqUakAAobO1vBAByjllxSaM3lXwEfEmFb5wM6cWWP5~ZIWgmn9O9U3vLGcP1qERB3YAT-JIUxjaA4x9fvuk56PZZpuh3t0quVJhgEU7GSZov7k3oEcdG9VcQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4' alt='wolrd-map'/>
                    <Button position={'absolute'} bottom={'100px'} right={2}>Contact Us</Button>
                </Box>
            </Box>
        </Hide>
        ...
        <Show below="500px">
            <Box
                ...
                bg={'#42A7C3'}
            >
                <Image position={'absolute'} w={'100%'} h={'100%'} src='https://s3-alpha-sig.figma.com/img/d4f4/9952/37c462a1c541b7a812220d9a0ad0c7ce?Expires=1679875200&Signature=XQgdDg20KSFHjEetzwZYdILmITubkuNf96VTvQZwUonMNcbP6yySLBapZakm70CxJdeO8fpd-WirZwssIKXfiaabAwkZnvYithHyWWXz84~L-fMRo7dcdgSDI8wVVm~O~SWdU3cxqyKCLXK2F~SuyXWQNtz6y2~-j80RPtzY1vNJipGE49mElsgeNKNTnnG4vcrH5YwhdpNc3~~mJC-KSAIM0dmGUWnqUakAAobO1vBAByjllxSaM3lXwEfEmFb5wM6cWWP5~ZIWgmn9O9U3vLGcP1qERB3YAT-JIUxjaA4x9fvuk56PZZpuh3t0quVJhgEU7GSZov7k3oEcdG9VcQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4' alt='wolrd-map'/>
                <Box>
                    <Text
                        textAlign={'center'}
                        fontSize={['20px']}
        ...
        <Hide below='900px'>
            <SimpleGrid columns={[1,2,2,3]} mt={10}>
                {
                    dataforDesktop.map((el,index)=><ClientCard key={index} url={el.url} name={el.name}/>)
                }
            </SimpleGrid>
        </Hide>
        <Show below='900px'>
        <SimpleGrid columns={[1,2,2,3]} mt={10}>
            {
                dataBelowDesktop.map((el,index)=><ClientCard key={index} url={el.url} name={el.name}/>)
            }
        </SimpleGrid>
        </Show>
